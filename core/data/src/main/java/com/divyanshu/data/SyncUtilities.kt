...
suspend fun Synchronizer.changeListSync(
    randomInterestsFetcher: suspend () -> NetworkInterest,
    favouriteListFetcher: () -> Flow<List<InterestEntity>>
) = suspendRunCatching {
    val changeList = randomInterestsFetcher
    val favouriteList = favouriteListFetcher
}.isSuccess
